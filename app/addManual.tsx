...
export default function AddManualScreen() {
    ...
    return (
        <View style={styles.container} onStartShouldSetResponder={() => true} onResponderRelease={() => Keyboard.dismiss()}>
            <SafeAreaView>
                <Text style={styles.label}>Issuer</Text>
                <TextInput style={styles.input} value={issuer} onChangeText={setIssuer} placeholder="Google" />

                <Text style={styles.label}>Account label</Text>
                <TextInput style={styles.input} value={label} onChangeText={setLabel} placeholder="name@email.com" />

                <Text style={styles.label}>Secret</Text>
                <TextInput style={styles.input} value={secret} onChangeText={setSecret} placeholder="JBSWY3DPEHPK3PXP" autoCapitalize="characters" />

                <Text style={styles.label}>Digits</Text>
                <TextInput style={styles.input} value={digits} onChangeText={setDigits} keyboardType="number-pad" />
